...
3. <ins>Find one or more datasets and demonstrate potential disclosure risks. You can start with identification disclosure. If you are working with continuous synthetic variables, be creative about how you calculate the identification disclosure risks.</ins>
